...
import org.json.JSONObject; /**需要下载SDK的jar http://ai.baidu.com/sdk#bfr*/
...
import com.google.gson.JsonParser; /** 需要下载Json的jar https://download.csdn.net/download/honeygirls/11016892 */
...
//        options.put("face_field", "age,beauty,expression,faceshape,gender,glasses,race,qualities");
	...
	public static void main(String[] args) throws Exception {
		...
		JSONObject res = Test02.getFaceValues("C:/Users/Administrator/Desktop/1.png");
        System.out.println("-----------------------------------------------");
        System.out.println(res.toString(2));
        System.out.println("-----------------------------------------------");
        System.out.println( "颜值："+Test02.getBeauty(res.toString(2)) );
        System.out.println( "年龄："+Test02.getAge(res.toString(2)) );
        System.out.println( "性别："+Test02.getSex(res.toString(2)) );
